  ...
  return (
    <div className="min-h-screen bg-auth-pattern bg-cover bg-center bg-no-repeat flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full p-6 md:p-12">
        <div className="bg-surface p-8 rounded-2xl shadow-sm border border-gray-100 prose max-w-none text-text-muted">
          <h1 className="text-3xl font-bold text-text mb-6">Aydınlatma Metni ve Gizlilik Politikası</h1>
          <p className="mb-4">
            Son Güncelleme: {new Date().toLocaleDateString('tr-TR')}
          </p>
          <h2 className="text-xl font-semibold text-text mt-6 mb-3">1. Veri Sorumlusu</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-text mt-6 mb-3">2. İşlenen Kişisel Veriler ve İşlenme Amacı</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-text mt-6 mb-3">3. Kişisel Verilerin Aktarılması</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-text mt-6 mb-3">4. Haklarınız</h2>
          <p className="mb-4">
