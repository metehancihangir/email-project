  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 bg-surface p-8 rounded-2xl shadow-xl max-w-sm w-full"
      >
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center text-sm text-gray-500 hover:text-gray-800 transition-colors mb-6">
